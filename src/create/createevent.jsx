        ...
        <div classn="eventcontainer">
            <div class="event">
                ...
                <div class="input-element">
                    ...
                    <span class="error-msg" id="eventNameErr"></span>
                </div>
                <div className="input-element">
                    <label> Date & Time</label>
                    <div><input type="text" name="date_time" id="dateTime"/></div>
                    <span class="error-msg" id="dateTimeErr"></span>
                </div>
                <div className="input-element">
                    <label> Address</label>
                ...
                <div className="input-element">
                    ...
                    <span class="error-msg" id="eventTypeErr"></span>
                </div>
                <div className="input-element">
                    <label> Event Description</label>
                    <div> <textarea id="eventDescription" name="event_description" rows="4" cols="50"> </textarea></div>
                    <span class="error-msg" id="event_descriptionErr"></span>
                </div>
                <div className="input-element">
                    <input type="checkbox"/> I accept the terms
                </div>
                <div className="input-element">
                    <h6 class="event-read-terms"><u>Read our T&Cs</u></h6>
                </div>
